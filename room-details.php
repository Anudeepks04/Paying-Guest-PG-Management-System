	...
	<div class="ts-main-content">
		...
		<div class="content-wrapper">
			...
			<table id="zctb" class="table table-bordered " cellspacing="0" width="100%" border="1">
						 ...
						 <span style="float:left" ><i class="fa fa-print fa-2x" aria-hidden="true" OnClick="window.print();" style="cursor:pointer" title="Print the Report"></i></span>
						 <div class="text-center">
							<span style="float:right"><button onclick="window.print();">Print</button></span>
						 </div>			
									<tbody>
<?php	
$aid=$_SESSION['login'];
